...
namespace WebApi.Controllers
{
    ...
    public class PlayerController : ControllerBase
    {
        ...
        public PlayerController(NBA_DBContext context)
        {
            ...
            //     var query = (from s in context.allPlayers
            //                  join ps in context.PlayerSelection on s.Player_key equals ps.Player_key
            //                  where ps.TeamName=="searchstring"
            //                  select s).ToList();
            // }
        ...
        [Route("getPlayersFromTeam")]
        [HttpGet]
        public List<Player> getPlayersFromTeam([FromQuery] string searchstring)
        {
            var query = (from s in context.allPlayers
                             join ps in context.PlayerSelection on s.Player_key equals ps.Player_key
                             where ps.TeamName=="searchstring"
